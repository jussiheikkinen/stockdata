...
<h1 style="margin-left:7%;">NASDAQ / NYSE </h1>
<content>
	<article>
		...
		<input type="text" name="osake" value="" style='width:15%;'>
		<input type="submit" name="haku" value="Haku">
		</form>
		...
		if (isset($_GET['haku'])){
			...
			$hClose = haeHistoria( $nimi, $from[1], $from[2], $from[0], $to[1], $to[2], $to[0], $interval);
				//Käännetään php array json formaattiin, koska javascript ei osaa lukea sitä
...
// JSON käännetään javascript arrayksi
var array = JSON.parse( '<?php echo $history;?>' ); 
