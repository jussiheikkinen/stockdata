...
<content>
	<article id= "salkut">
		...
		// Hakee historialliset pörssitiedot
		if (isset($_GET['haku'])){
			$nimi = $_GET['osake'];
			//explodataan päivämäärä formaatista 12-2-2014 taulukkoon näin [0]=>[12] [1]=>[2] [2]=>[2014]
		...
		//Hakee tämänhetkiset tiedot yrityksestä (functions.php)
